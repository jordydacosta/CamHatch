                    ...
                    <div style="width: 100%;">
                        <form action="{{route('profiles.update', $profiles->id)}}" method="post">
                            <table class="table table-hover custom_datatable_layout" id="orders-table">
                                ...
                                <tr>
                                    <th class="col-md-4 text-center"><input type="text" id="name" name="name" placeholder=""></th>
                                    <th class="col-md-4 text-center"><input type="text" id="email" name="email" placeholder=""></th>
                                    <th class="col-md-4 text-center"><input type="text" id="password" name="password" placeholder=""></th>
